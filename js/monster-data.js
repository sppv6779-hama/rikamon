...
"baby_electric": "https://image2url.com/r2/default/images/1772110757407-907b4444-1991-42e5-bbc0-b5f27ec418d2.png",
  ...
  const MONSTERS = {
      ...
      baby_wind: { name: 'ブリーズベビー', stage: 'baby', type: 'wind', emoji: '🍃', color: '#2dd4bf' },
      ...
      growth_wind: { name: 'ゲイルウィング', stage: 'growth', type: 'wind', emoji: '🌬️', color: '#14b8a6' },
      ...
      // 成熟期（風）
      mature_wind_accuracy: { name: 'エアロ・セージ', stage: 'mature', type: 'wind', variant: 'accuracy', emoji: '🦉', color: '#0d9488' },
      mature_wind_speed: { name: 'ストーム・ラプター', stage: 'mature', type: 'wind', variant: 'speed', emoji: '🦅', color: '#06b6d4' },
      mature_wind_balance: { name: 'サイクロン・ガーディアン', stage: 'mature', type: 'wind', variant: 'balance', emoji: '🐲', color: '#0f766e' },
      ...
      // 完全体（風）
      perfect_wind_accuracy: { name: 'シルフィード・オラクル', stage: 'perfect', type: 'wind', variant: 'accuracy', emoji: '🪽', color: '#0f766e' },
      perfect_wind_speed: { name: 'ジェット・テンペスト', stage: 'perfect', type: 'wind', variant: 'speed', emoji: '🌪️', color: '#0891b2' },
      perfect_wind_balance: { name: 'エアリアル・バスティオン', stage: 'perfect', type: 'wind', variant: 'balance', emoji: '🏰', color: '#0e7490' },
      ...
      // 究極体（風）
      ultimate_wind_accuracy: { name: 'アネモス・カノン', stage: 'ultimate', type: 'wind', variant: 'accuracy', emoji: '🕊️', color: '#115e59' },
      ultimate_wind_speed: { name: 'ヴォルテックス・ノヴァ', stage: 'ultimate', type: 'wind', variant: 'speed', emoji: '🌪️', color: '#155e75' },
      ultimate_wind_balance: { name: 'ストラトス・レガリア', stage: 'ultimate', type: 'wind', variant: 'balance', emoji: '👑', color: '#134e4a' }
    };;
  ...
  const DESCRIPTIONS = {
        ...
        baby_wind: 'ブリーズベビー。そよ風と一緒に遊ぶ風の幼体。圧力の計算を覚えるほど、起こす風の強さを上手に調整できる。',
        ...
        growth_wind: '翼の羽ばたきで気流を操ることを覚えた成長期。上昇気流を利用して軽やかに飛び回り、小さなつむじ風で相手の姿勢を崩す。',
        ...
        mature_wind_accuracy: '気圧差のわずかな揺らぎを感じ取る観測者。羽ばたきひとつで狙った一点にのみ高圧風を当てる精密制御を誇る。',
        mature_wind_speed: 'ジェット気流のような翼で空を切り裂く高速型。連続して放つ真空刃で相手の隙を生み、瞬時に背後を取る。',
        mature_wind_balance: '暴風と静風を切り替える守護者。攻撃時はサイクロン、守備時は緩衝気流で仲間を包む。',
        ...
        perfect_wind_accuracy: '大気データを先読みし、天候の変化を数秒先に捉える完全体。狙撃のように一点へ超高圧の風弾を撃ち込む。',
        perfect_wind_speed: 'ジェットの尾を引く超高速形態。移動軌跡そのものが連鎖竜巻となり、戦場全体を制圧する。',
        perfect_wind_balance: '空中要塞のような巨躯を得た防衛型。風圧砲と気流シールドを同時展開し、前線を押し上げる。',
        ...
        ultimate_wind_accuracy: '地球規模の気圧配置を読む風の神鳥。嵐を鎮めることも、一点に神罰の風圧を落とすこともできる。',
        ultimate_wind_speed: '音速を超える暴風と同化した究極体。空を走るだけで超大型竜巻が連続発生し、地形さえ作り変える。',
        ultimate_wind_balance: '天空の循環を司る王。暴風の力と穏やかな偏西風を使い分け、世界の気象を恒常へ導く。'
      };
